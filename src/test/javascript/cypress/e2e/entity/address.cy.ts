...
describe('Address e2e test', () => {
  ...
  const addressSample = {
    street: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=',
    city: 'West Beulah',
    province: 'payment dot-com Gorgeous',
    country: 'Gabon',
  ...
  describe('new Address page', () => {
    ...
    it('should create an instance of Address', () => {
      ...
      cy.get(`[data-cy="city"]`).type('Eugene').should('have.value', 'Eugene');

      cy.get(`[data-cy="province"]`).type('Optional USB navigate').should('have.value', 'Optional USB navigate');

      cy.get(`[data-cy="country"]`).type('Albania').should('have.value', 'Albania');

      cy.get(`[data-cy="addressType"]`).select('PHYSICAL_ADDRESS');

      cy.get(`[data-cy="telephoneWork"]`).type('Bike Paradigm V').should('have.value', 'Bike Paradigm V');

      cy.get(`[data-cy="telephoneHome"]`).type('rich seamless V').should('have.value', 'rich seamless V');

      cy.get(`[data-cy="cellphone"]`).type('Human Hat imple').should('have.value', 'Human Hat imple');
